...
const CompanionList = ({title,companions,classNames}:
CompanionsListProps) => {
    return (
        <article className={cn('companion-list', classNames)}>
            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        <TableHead className="text-lg 2-2/3">Lesson</TableHead>
                ...
                <TableBody>
                    ...
                    { companions?.map(({id, subject, name,duration, topic })=>(
                        <TableRow key={id}>
                            ...
                            <TableCell>
                                <div className="subject-badge text-center w-fit max-md:hidden">
                                    {subject}
                                </div>
                                {/* mobile responsive*/}
                            ...
                            <TableCell>
                                <div className="flex items-center gap-2 w-full">
                                    ...
                                    <Image src="/icons/clock.svg" alt="minutes"
                                           width={12} height={12} className="md:hidden"
                                    />
                                </div>
                            </TableCell>
