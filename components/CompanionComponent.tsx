...
const CompanionComponent = ({companionId, subject, topic, name, userName, userImage, 
                                style, voice}:CompanionComponentProps) => {
    ...
    const handleCall = async  () => {
        ...
        //@ts-expect-error
        vapi.start(configureAssistant(voice, style), assistanceOverrides)
    }
            ...
            <section className="flex gap-8 max-sm:flex-col">
                ...
                <div className="user-section">
                    ...
                    <button className={cn('rounded-lg py-2 cursor-pointer transition-colors w-full text-white',
                        ...
                        "End Session" : callStatus===CallStatus.CONNECTING ? 'Connecting' : 'Start Session'}
                    </button>
                </div>
            </section>
